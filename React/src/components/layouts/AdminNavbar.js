  ...
  return (
    <nav className="navbar ms-navbar">
      <div
        ...
        onClick={navToggle}
      >
        <span className="ms-toggler-bar HideToggle" style={{ backgroundColor: '#29748c' }} />
        <span className="ms-toggler-bar HideToggle" style={{ backgroundColor: '#29748c' }} />
        <span className="ms-toggler-bar HideToggle" style={{ backgroundColor: '#29748c' }} />
      </div>
      <div className="logo-sn logo-sm ms-d-block-sm">
        <Link className="pl-0 ml-0 text-center navbar-brand mr-0" to="/" style={{ height: "40px" }}>
          {/* <img src={logosmdark} alt="logo" />{" "} */}
        </Link>
      </div>
      <ul className="ms-nav-list ms-inline mb-0" id="ms-nav-options" style={{
        backgroundColor: isDesktop ? "#fff" : "#29748c", // Adjusted syntax
      }}>
        ...
        <Dropdown className="ms-nav-item ms-nav-user">
          ...
          >
            <Dropdown.Header>
              <h6 className="dropdown-header ms-inline m-0">
                <span className="text-disabled">Welcome, {UserName}</span>
              </h6>
            </Dropdown.Header>
            {/* <Dropdown.Divider /> */}
            {/* <Dropdown.Item
